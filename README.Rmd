...
```{r figure2, dpi=105, fig.height=5, fig.width=11, fig.align="center"}
...
```{r suppl_figure4, dpi=105, fig.height=6, fig.width=6, fig.align="center"}
df.plot <- fly.dump %>%
...
```{r suppl_figure1, dpi=105, fig.height=5, fig.width=11, fig.align="center"}
...
```{r suppl_figure2, dpi=105, fig.height=5, fig.width=11, fig.align="center"}
...
```{r suppl_figure3, dpi=105, fig.height=5, fig.width=11, fig.align="center"}
p.suppfig3a + labs(tag = "a") + p.suppfig3b + labs(tag = "b") + plot_annotation(tag_levels = "a")
```

#### Suppl Figure 5
UMAP dimension reduction
```{r suppl_figure5, dpi=105, fig.height=9, fig.width=7, fig.align="center"}
